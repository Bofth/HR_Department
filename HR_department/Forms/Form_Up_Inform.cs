...
namespace HR_department
{
    public partial class Form_Up_Inform : Form
    {
        ...
        public Form_Up_Inform(Employee employeeInfo)
        {
            ...
            comboBox2.Text = employeeInfo.Specialization.ToString();
        ...
        {
            Education enumValue;
            Spezialisation spezialisation;
            if (Enum.TryParse(comboBox2.Text, out spezialisation))
            {
                if (Enum.TryParse(comboBox1.Text, out enumValue))
                {
                    ...
                    if (result == DialogResult.Yes)
                    {
                        ...
                        try
                        {
                            ...
                            ChengetEmployee.Specialization = spezialisation;
